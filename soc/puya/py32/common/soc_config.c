...
#if defined(CONFIG_SOC_SERIES_PY32H5X) || defined(CONFIG_SOC_SERIES_PY32H7RSX) ||                \
	defined(CONFIG_SOC_SERIES_PY32L5X) || defined(CONFIG_SOC_SERIES_PY32U5X) ||              \
	defined(CONFIG_SOC_SERIES_PY32WBX)
	LL_DBGMCU_EnableTraceClock();
#endif
#if !defined(CONFIG_SOC_SERIES_PY32WBX) && defined(DBGMCU_CR_TRACE_IOEN)
