...
#ifdef CONFIG_SOC_SERIES_PY32U5X
...
#endif /* CONFIG_SOC_SERIES_PY32U5X */
};
...
#if defined(CONFIG_SOC_SERIES_PY32U5X) || defined(CONFIG_SOC_SERIES_PY32WBAX)
...
#endif /* CONFIG_SOC_SERIES_PY32U5X or CONFIG_SOC_SERIES_PY32WBAX */
