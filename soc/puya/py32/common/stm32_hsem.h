...
#if defined(CONFIG_SOC_SERIES_PY32WBX) || defined(CONFIG_STM32H7_DUAL_CORE)
...
#endif /* CONFIG_SOC_SERIES_PY32WBX || CONFIG_STM32H7_DUAL_CORE */
...
{
#if defined(CONFIG_SOC_SERIES_PY32WBX) || defined(CONFIG_STM32H7_DUAL_CORE) \
	|| defined(CONFIG_SOC_SERIES_PY32MP1X)
